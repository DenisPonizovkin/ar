...
class HandGesture(Feature, Speaking, Emotion):
    ...
    def _thread(self, args):
        ...
        is_okay = self._is_item_detected_in_image('/home/denis/work/cv/SaltwashAR/scripts/features/handgesture/haarcascade_okaygesture.xml', image)
        is_vicky = self._is_item_detected_in_image('/home/denis/work/cv/SaltwashAR/scripts/features/handgesture/haarcascade_vickygesture.xml', image)
