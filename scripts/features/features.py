...
class Features:
    ...
    def __init__(self, config_provider):
        ...
        if (config_provider.acting or config_provider.audio_classifier or
            ...
            from features.texttospeech.texttospeech import TextToSpeech
        ...
        if (config_provider.acting or config_provider.browser or
            ...
            from features.speechtotext.speechtotext import SpeechToText
        ...
        if config_provider.hand_gesture:
            from features.handgesture.handgesture import HandGesture
            self.hand_gesture = HandGesture(text_to_speech)

        self.happy_colour = None
        if config_provider.happy_colour:
            from features.happycolour.happycolour import HappyColour
        ...
        if config_provider.optical_character_recognition:
            from features.opticalcharacterrecognition.opticalcharacterrecognition import OpticalCharacterRecognition
        ...
        if config_provider.shapes:
            from features.shapes.shapes import Shapes
